...
| --- | ------------------------------------- | ------------------------------------------------------------- | ----- |
| 1.1 | Launch app on Free tier               | Settings shows "Free" badge                                   |       |
| 1.2 | Tap + with 2 alarms (trigger paywall) | PaywallView appears with Liquid Glass styling                 |       |
| 1.3 | Verify plan options                   | Monthly and Annual toggle visible with StoreKit prices        |       |
| 1.4 | Select Monthly, tap Subscribe         | StoreKit purchase sheet appears                               |       |
| 1.5 | Confirm purchase                      | Paywall dismisses, tier updates to Plus                       |       |
| 1.6 | Open Settings                         | Shows "Plus" badge, subscription info updated                 |       |
| 1.7 | Repeat with Annual plan               | Same flow, annual price shown, tier updates                   |       |
