...
class DateCalculator
    ...
    constructor() {
         ...
         */
        private fun iosWeekdayToJavaDayOfWeek(iosWeekday: Int): DayOfWeek = when (iosWeekday) {
            1 -> DayOfWeek.SUNDAY
            2 -> DayOfWeek.MONDAY
            3 -> DayOfWeek.TUESDAY
         ...
         */
        private fun clampDay(day: Int, yearMonth: YearMonth): Int = day.coerceAtMost(yearMonth.lengthOfMonth())
